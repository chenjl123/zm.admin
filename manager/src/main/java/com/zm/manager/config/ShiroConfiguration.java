...
import com.zm.manager.shiro.ShiroRealm;
...
//        }
	...
	public SimpleCookie remeberMeCookie() {
		...
		//scookie.setMaxAge(3600);  不设置默认1年
		return scookie;
	}
	...
	public RedisManager redisManager() {
		...
		redisManager.setExpire(expire);// 配置缓存过期时间单位秒
		redisManager.setTimeout(timeout);//客服端超时时间，单位毫秒
		return redisManager;
	}
